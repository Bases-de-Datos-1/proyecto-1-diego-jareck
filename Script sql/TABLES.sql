...
CREATE TABLE Habitacion_Comodidades (
    ID_Tipo_Habitacion INT FOREIGN KEY REFERENCES Habitacion_Tipo(ID_Tipo_Habitacion),
    ID_Comodidad INT FOREIGN KEY REFERENCES Comodidades(ID_Comodidad),
    PRIMARY KEY (ID_Tipo_Habitacion, ID_Comodidad)
);
